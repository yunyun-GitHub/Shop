...
# 第一步:准备支付宝的应用数据(调试阶段使用沙箱环境),上线之后只需要替换这四个内容
...
# 第二步:订单支付的信息(自己系统的订单信息)
order_on = '20230502102948'  # 订单号
amount = '299.89'  # 支付金额
subject = '生鲜商城订单{}支付'.format(order_on)  # 支付页面显示的标题
